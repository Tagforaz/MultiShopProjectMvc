...
using MultiShopProjectMVC.ViewModels.Accounts;

namespace MultiShopProjectMVC.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterVM userVM,string? returnUrl)
        {
            ...
            if (userVM.Photo is not null)
            {
                user.Image = await userVM.Photo.CreateFileAsync(_env.WebRootPath, "assets", "img");
            }
            else
            {
